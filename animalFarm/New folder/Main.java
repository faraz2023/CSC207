...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Human.myFarmAnimals[15][15]=new Cow();
        ((Cow) Human.myFarmAnimals[15][15]).setLocation(15,15);
                        ...
                        for(int a=0;a!=(int)(480/10);a++){
                            for(int b=0;b!=(int)(640/6);b++){
                                if (Human.myFarmAnimals[a][b] != null)
                                    ...
                                    }else if (Human.myFarmAnimals[a][b] instanceof Cow) {
                                        ((Cow) Human.myFarmAnimals[a][b]).move();
                                ...
                                if((Human.chicken_manure_age[a][b] !=null)){
                                    if(System.currentTimeMillis() - Human.chicken_manure_age[a][b]>=10000){
                                        Human.chicken_manure_age[a][b] = null;
                                        Human.myFarmAnimals[a][b] = new Object();
                                    }
                                }
                            }
                        }
            ...
            for (int b = 0; b != (int) (640 / 6); b++) {
                if (Human.myFarmAnimals[a][b] != null) {
                    ...
                    if (Human.myFarmAnimals[a][b] instanceof Chicken) {
                        ...
                        ((Cow) Human.myFarmAnimals[a][b]).draw(gc);
                    } else if (Human.myFarmAnimals[a][b] instanceof  Human) {
